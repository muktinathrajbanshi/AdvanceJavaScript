...
//? Assignment operators in programming are symbols used to assign values to variables. They take the value on the right side of the operator
//?  and assign it to the variable on the left side.

// examples
// var myFavNum = 15;
// Assigns the value 15 to the variable myFavNum
// var channelName = 'muktinath rajbanshi'

//* ===================================
//* 2: Arithmetic operators
//* ====================================

//? Arithmetic operators in programming perform basic mathematical operations on variables or values. They include addition, subtraction, 
...
// when working with floating-point numbers in JavaScript, consider using methods like toFixed() when precise
...
//? For example, to concatenate the strings "Hello" and "World", you would use the following code:
...
//? The strict equality === operator is also a comparison operator, but it compares two values true only if they
...
//! Q: Write a program that determines if a person is eligible to drive based on their age being greater than 
//! or equal to 18 and having a valid driver's license❓
...
//! Q: Let's say you have a variable score representing a student's exam score. If the score is greater
//!  than or equal to 60, the student passes; otherwise, they fail. Use the conditional (ternary) operator 
//! to determine the result and store it in a variable called result. Log the result to the console❓
