...
//! Arrays as Objects:  Arrays in JavaScript are a specific type of object that has numeric keys (indices) 
//! and a length property. The indices are automatically maintained, and the length property is automatically updated
//!  when you add or remove elements from the array.
...
//*  variable. It is a versatile and dynamic object. It can hold various data types, including numbers, strings, 
//* objects, and even other arrays. Arrays in JavaScript are zero-indexed i.e. the first element is accessed with
//*  an index 0, the second element with an index of 1, and so forth.
...
//* for...of Loop: The for...of loop is used to iterate over the values of an iterable object, such as arrays, 
//* strings, or other iterable objects.
...
// ? 3: forEach Method
//* The arr.forEach() method calls the provided function once for each element of the array. The provided function 
//* may perform any kind of operation on the elements of the given array.
...
// ? 4: map function
//* map() creates a new array from calling a function for every array element. map() does not change the original 
//* array.
...
// map -  Creates a new array with transformed elements
    ...
    //* Use Case:
    //? forEach: Used when you want to iterate over the array elements and perform an action on each element, but you
...
//? 2: lastIndexOf Method: The lastIndexOf() method of Array instances returns the last index at which a given 
//? element can be found in the array, or -1 if it is not present. The array is searched backwards, starting at 
//? fromIndex.
...
//? 1: find Method: The find method is used to find the first element in an array that satisfies a provided testing
//?  function. It returns the first matching element or undefined if no element is found.
...
//? 2: findIndex Method: The findIndex() method of TypedArray instances returns the index of the first element in a
//?  typed array that satisfies the provided testing function. If no elements satisfy the testing function, -1 is
//?  returned.

//* 3:  filter Method: The filter method creates a new array with all elements that pass the test implemented by
...
//! 1: Using the map method, write a function that takes an array of strings and returns a new array where each
...
//! 2: Using the map method, write a function that takes an array of numbers and returns a new array where each
//! number is squared, but only if it's an even number.
...
//! 3: Using the map method, write a function that takes an array of names and ruturns a new array where each name
//! is prefixed with "Mr. ".
...
//? Reduce method
// The reduce method in JavaScript is used to accumulate or reduce an array to a single value. It iterates over 
// the elements of an array and applies a callback function to each element, updating an accumulator value with 
// the result. The reduce method takes a callback function as its first argument and an optional initial value for
//  the accumulator as the second argument.
