...
//?  In JavaScript, an object is a collection of key-value pairs, where each key is a string (or a symbol) and 
//? each value can be any data type, including other objects. Objects can have properties and methods, making 
...
//* Methods:
//* =================================
//? Methods in objects are functions associated with the object. They can be invoked using the same notation as 
//? properties:
...
// Objects are excellent for modeling real-world entities. For instance, you might represent a car, a user, or a
// product as an object with properties like color, brand, username, etc.
...
//! Explain the difference between passing objects by reference and by value in JavaScript. Provide an example to
//!  demonstrate each scenario.

//? sol: In JavaScript, primitive data types like numbers and strings are passed by value, while objects are passed
//?  by reference.
//? Passing by value: When passing by value, a copy of the primitive value is created and passed to the function or
//?  assigned to a variable. Any changes made to the copy do not affect the original value.

// let a = 10;
// const modifyValue = () => (x = 20);

// console.log(modifyValue(a));
// console.log(a);

//? Passing by reference: When passing by reference, a reference to the memory location of the object is passed
//?  to the function or assigned to a variable. Any changes made to the object through this reference will affect
//?  the original object.

// let obj = { id: 5, name: "muktinath" };

// let obj1 = obj;

// obj1.name = "muktinath rajbanshi";
// console.log(obj1);
// console.log("original ", obj);

// To avoid this behavior and create a true copy of the object, you can use methods like Object.assign() or the
// spread operator (...): 
// Passed by value
...
//  newObj.name = "muktinath rajbanshi";
//  console.log(newObj);
//  console.log("original", obj);
...
//? Independent objects (even if they look alike) are not equal:
    // const obj1 = { name: "muktinath" };
    // const obj2 = { name: "muktinath" };
    // const obj3 = obj1;
...
//?JSON is a data interchange format derived from JavaScript objects. Objects can be easily converted to JSON and
//?  vice versa.
...
//* In this example, the greet method is defined using the "Method Shorthand" syntax. It's a more concise way to 
...
//? 3: Object.entries(): Returns an array containing arrays of key-value pairs for each enumerable own property of
//?  an object.

// let entries = Object.entries(product);
// console.log(entries);

//? 4: Object.hasOwnProperty(): Returns a boolean indicating whether the object has the specified property as an 
//? own property.
...
//? 6: Object.freeze(): Freezes an object, preventing new properties from being added to it and existing properties 
...
//* ================================================
//! Problem: Given an object representing a student, write a function to add a new subject with its corresponding 
//!  grade to the student's record. Also check if the grades property is present or not?
...
// // Example usage:
// let objA = { name: "Muktinath", age: 26, city: "New York" };
// let objB = { name: "Muktinath", age: 25, city: "New York" };
...
//* ================================================
//! Problem: Write a function that transforms an array of an objects into an object where the keys are the 
//! objects' ids.
