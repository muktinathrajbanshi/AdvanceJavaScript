...
//? This function will allow us to find element from the last to first of the array based on a condition.
    ...
    // console.log(array.findLast((curElem) => curElem > 4));
    // console.log(array.findLastIndex((curElem) => curElem));

//* ===============================================
//*  New Array.prototype functions
//* ==============================================

const myNames = ["muktinath", "rajbanshi", "ok", "kodyfier"];
...
//? Array.prototype.toSpliced(start, deleteCount, ...items);
    // const splicedArr = myNames.toSpliced(1, 1, "Rose");
    // console.log("original", myNames);
...
//* It takes two arguments: the index of the element to be changed and the new value. It returns a new array with
//*  the changed element, leaving the original array unchanged.

    const replaceWith = myNames.with(1, "@muktinathrajbanshi219");
    console.log("original", myNames);
