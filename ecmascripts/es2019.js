...
//? flatMap() is a new Array instance method that combines flat() with map(). It’s useful when calling a function 
//? that returns an array in the map() callback, but you want your resulted array to be flat:

// const arr = ["My name", "is muktinath", "rajbanshi"];
...
// const person = { name: "muktinath", age: 23 };
...
//?  identifier that is immutable and guaranteed to be unique. Symbols are often used as property keys in objects 
//? to avoid naming conflicts.

//? The Symbol.prototype.description property is a new feature introduced in ECMAScript 2019 (ES10). It allows you
//?  to retrieve the description of a symbol. When you create a symbol, you can optionally provide a description 
//? as its parameter. The description property lets you access this description.
...
//*  Optional catch binding
//* ===============================
//? In ECMAScript 2019 (ES10), a new feature called "optional catch binding" was introduced for the try...catch 
//? statement. This feature allows you to omit the parameter in the catch block, making it optional.
